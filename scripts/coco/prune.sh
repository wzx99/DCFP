...
ALIGN_CORNER='True'
PRUNE_RATIO=0.6
SNAPSHOT_DIR=ckpt/COCO/dcfp_pretrain_deeplabv3/dcfp_prune_06
RESUME_DIR=ckpt/COCO/dcfp_pretrain_deeplabv3/COCO_scenes_6000.pth
SCORE_DIR=ckpt/COCO/dcfp_pretrain_deeplabv3/score.pth
